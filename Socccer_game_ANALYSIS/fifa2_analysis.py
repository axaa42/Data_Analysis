...
#TThis for loop will loop once, and get the proportion amount of sample from each group based on 
...
for x in range(100):
     ...
     aa=round(stratified["Sprint speed"].mean())
     
     o.append(aa)

print(o)
plt.scatter(range(1,101), o)
plt.axhline(data['Sprint speed'].mean())
